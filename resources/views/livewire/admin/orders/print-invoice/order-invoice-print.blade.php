                        ...
                        <div class="card-footer px-4">
                            <div class="row">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <h5 class="mb-1 fw-500 text-base">{{ $customer->name ?? 'Walk-In Customer' }}</h5>
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row mb-50 align-items-center">
                                            <div class="col text-sm"> Pieces {{ $lang->data['quantity'] ?? 'Quantity' }}:</div>
                                            <div class="col-auto text-sm">
                                                {{ number_format($quantity, 2) }}</div>
                                        </div>
                                        <div class="row mb-50 align-items-center">
                                        ...
                                        <div class="row mb-50 align-items-center">
                                            <div class="col text-sm">{{ $lang->data['is_invoice_paid'] ?? 'Status' }}:
                                            </div>
                                            <div class="col-auto text-sm">
                                                {{ $is_invoice_paid}}
                                            </div>
                                        ...
                                        <div class="row mb-50 align-items-center">
                                            <div class="col text-sm">{{ $lang->data['total_paid_amount'] ?? 'Paid Amount' }}:
                                            </div>
                                            <div class="col-auto text-sm">
                                            {{ getCurrency() }} {{number_format($total_paid_amount, 2)}}
                                            </div>
                                        </div>
                                        <div class="row mb-50 align-items-center">
                                            <div class="col text-sm">{{ $lang->data['remain_amount'] ?? 'Remain Amount' }}:
                                            </div>
                                            <div class="col-auto text-sm">
                                            {{ getCurrency() }} {{ number_format( $remain_amount, 2)}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                   ...
                                   <p class="b_top">المغسلة غير مسئولة عن تغيير اللون وانكماش الثياب والغياب لمدة شهرين</b></p>
                                   <p class="b_top">Laundery is not Responsible of cloth color change or dispearing for more than 2 months </b></p>
                    ...
                    <div class="invoice-details" style="border-top:none;">
                        ...
                        <div class="invoice-footer mb-15">
                            <div class="row-data">
                                ...
                                <h4 class="my-5">{{ $customer->name ?? ($lang->data['walk_in_customer'] ?? 'Walk-In Customer') }}<br />
                                    <p>{{ $customer->phone ?? '' }}</p>
                                    <!-- {{ $customer->email ?? '' }}<br /> -->
                            ...
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['quantity'] ?? 'Quantity' }}:
                                    </h5>
                                </div>
                                <h5 class="my-5">Pieces {{ number_format($quantity, 2) }}
                                </h5>
                            </div>
                            <!-- moayed code  -->
                            <div class="row-data">
                            ...
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['is_invoice_paid'] ?? 'Status' }}:
                                    </h5>
                                </div>
                                <h5 class="my-5"> {{ $is_invoice_paid}}
                                </h5>
                            </div>
                            ...
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['total_paid_amount'] ?? 'Paid Amount' }}:
                                    </h5>
                                </div>
                                <h5 class="my-5"> {{ getCurrency() }} {{  number_format($total_paid_amount, 2)  }}
                                </h5>
                            </div>
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['remain_amount'] ?? 'Remain Amount' }}:
                                    </h5>
                                </div>
                                <h5 class="my-5"> {{ getCurrency() }} {{ number_format( $remain_amount, 2)}}
                                </h5>
                            </div>
                            <hr>
                        ...
                        <div class="invoice_address">
                            <div class="text-center">
                                ...
                                <p class="b_top">Top Laundery Service IN Dubai <b>{{ getApplicationName() }}</b></p>
                            </div>
                        </div>
                    </div>
                </div>
